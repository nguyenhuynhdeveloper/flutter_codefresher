...
Buổi 17 : Tổng hợp đánh giá tất cả các bài đồ án cuối khoá
Json là giống như 1 adapter giao lưu giữa client và server

Firebase database chọn server nếu là us thì hơi bị chậm . chọn singgapo thì nhanh hơn
