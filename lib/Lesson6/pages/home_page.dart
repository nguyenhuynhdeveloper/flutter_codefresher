...
import 'package:flutter_18/Lesson6/pages/auth/sign_up_page.dart';
import 'package:flutter_18/Lesson6/pages/calculator_page.dart';
import 'package:flutter_18/Lesson6/pages/flexdemo_page.dart';
import 'package:flutter_18/Lesson6/pages/whatsapp_page.dart';
import 'package:flutter_18/Lesson6/pages/ecommerce_page/ecommerce_page.dart';

//import các widget common dùng chung
import 'package:flutter_18/Lesson6/widgets/buttons/goto_page_button.dart';
      ...
      body: Center(   // widget căn giữa ra màn hình (hoặc giữa thằng widget cha của nó)
        child: Column(   //Widget mà các children bên trong xếp theo hàng dọc
          ...
          children: [
            ...
            GoToPageButton(
              text: 'Ecommerce page',
              routeName: EcommercePage.routeName,
            ),
          ],
        ),
      ),
